...
CreateContextAttribsARB :: #type proc(hdc : win32.Hdc, 
                                      shareContext : wgl.Hglrc, 
                                      attribList : ^i32) -> wgl.Hglrc #cc_c;
ChoosePixelFormatARB    :: #type proc(hdc : win32.Hdc, 
                                      piAttribIList : ^i32, 
                                      pfAttribFList : ^f32, 
                                      nMaxFormats : u32, 
                                      piFormats : ^i32, 
                                      nNumFormats : ^u32) -> win32.Bool #cc_c;
SwapIntervalEXT         :: #type proc(interval : i32) -> bool #cc_c;
GetExtensionsStringARB  :: #type proc(win32.Hdc) -> ^u8 #cc_c;
